...
$boxer = mysqli_query($conn, "SELECT id_lugar, nombre_lugar, desc_lugar, foto_lugar FROM lugar WHERE lugar.id_ciudad=$v2 ORDER BY nombre_lugar DESC");
$boxer2 = mysqli_query($conn, "SELECT id_ciudad, nombre_ciudad, desc_ciudad, foto_ciudad FROM ciudad WHERE ciudad.id_ciudad=$v2 ORDER BY nombre_ciudad DESC");
?>
<!DOCTYPE HTML>
<!--
	Forty by HTML5 UP
					...
					<section id="banner" class="style2">
						<div class="inner">
							...
							<?php   while ($row = mysqli_fetch_array($boxer2)){ ?>
								<h1><?php echo $row['nombre_ciudad']; ?></h1>
										<?php }; ?>  
							</header>
							<div class="content">
							...
							<?php  while ($row = mysqli_fetch_array($boxer)){ ?>
								<section>
									<a href="landingciudad.php" class="image">
										<img src="images/<?php echo $row['foto_lugar']; ?>" alt="" data-position="center center"/>
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
												<h3><?php echo $row['nombre_lugar']; ?></h3>
											</header>
