			...
			<div id="wrapper">
				...
				<!-- Note: The "styleN" class below should match that of the banner element. -->
					<header id="header" class="alt style2">
						<a href="index.php" class="logo"><strong>TORUSIAPP</strong> <span>by M&J</span></a>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
								...
								<section>
									...
									<div class="content">
										<div class="inner">
											...
											<p> es el continente más extenso y poblado de la Tierra. Con cerca de 45 millones de km², supone el 8,70 % del total de la superficie terrestre y el 29,45 % de las tierras emergidas y, con alrededor de 4 140 000 000 de habitantes, el 69 % de la población mundial. Se extiende sobre la mitad oriental del hemisferio Norte, desde el océano Glacial Ártico, al norte, hasta el océano Índico, al sur. Limita, al oeste, con los montes Urales, y al este, con el océano Pacífico.</p>
											<ul class="actions">
												<li><a href="generic.php" class="button">Llevame allí</a></li>
											</ul>
										</div>
									</div>
								</section>
